...
let
  ...
  impozyzHaipyrThreding iuzColemak izSentyr izEdj;
...
in
{
  hardware = {
    ...
    # ++ optional computerIs.rpi3B raspberrypiWirelessFirmware; # TODO
  ...
  boot = {
    ...
    # ++ (optionals computerIs.rpi3B [ # TODO
    #   "cma=32M" "console=ttyS0,115200n8" "console=ttyAMA0,11520n8" "console=tty0" "dtparam=audio=on" 
    # ]);
  ...
  powerManagement = {
    powerUpCommands = '' '' 
    + (optionalString impozyzHaipyrThreding ''
  ...
  virtualisation = mkIf saizAtList.max {
    libvirtd = {
      enable = true;
    };
